...
//         &[enclavekit::constants::COUNTER_SEED],
//         &program_id,
//     )
//     .0;
...
//         program_id,
//         &enclavekit::instruction::Initialize {}.data(),
//         enclavekit::accounts::Initialize {
//             payer: payer.pubkey(),
//             counter,
...
//     let counter_state = enclavekit::state::Counter::try_deserialize(&mut data).unwrap();
//     assert_eq!(counter_state.count, 0);
//     assert_eq!(counter_state.authority, payer.pubkey());

//     let instruction = Instruction::new_with_bytes(
//         program_id,
//         &enclavekit::instruction::Increment {}.data(),
//         enclavekit::accounts::Increment {
//             counter,
